...
function TodoList() {
  ...
  useEffect(() => {
    const data = [
      {id: 1, text: '산책가기', completed: false}, {id: 2, text: '멋사과제', completed: true}, {id: 3, text: '책읽기', completed: false}, {id: 4, text: '야구보기', completed: false}
  ...
  useEffect(() => {
    if (todos.length===count && count>0){
      alert("오늘 할 일을모두 완료하셨습니다")
    }
